        ...
        <div>
          ...
          <div className='flex flex-row w-full md:max-w-800 mx-auto items-center justify-center px-7 md:p-0'>
            ...
            <div className='w-full'>
              <form action="#">
                <AnchorDetect
                  className="text-black flex flex-row overflow-x-scroll"
                  items={[
                    "section-1",
                    "section-2",
                    "section-3",
                  ...
                  activeClass="bg-vinho text-white"
                  offsetTop={83}
                >
                  <div className="section-1 text-vinho border border-vinho rounded-md px-3 py-2 text-sm mx-5 text-nowrap cursor-pointer">Pratos Prontos</div>
                  <div className="section-2 text-vinho border border-vinho rounded-md px-3 py-2 text-sm mx-5 text-nowrap cursor-pointer">Feitos na Hora</div>
                  <div className="section-3 text-vinho border border-vinho rounded-md px-3 py-2 text-sm mx-5 text-nowrap cursor-pointer">Bebidas (Sucos e Refrigerantes)</div>
                  <div className="section-4 text-vinho border border-vinho rounded-md px-3 py-2 text-sm mx-5 text-nowrap cursor-pointer">Sobremesas</div>
                </AnchorDetect>
              </form>
            </div>
          </div>
